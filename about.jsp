<%-- 
    Document   : about
    Created on : 15 Mar, 2020, 11:36:05 AM
    Author     : kalyani
--%>
                ...
                <jsp:include page="navbar.jsp"></jsp:include>
                 ...
                 <%--   <jsp:include page="crousel.jsp"></jsp:include> --%>
                    <div class="row" >
                        ...
                        <br/>
                        <img src="assets/images/about us.jpg" style="width: 100%;height: 350px">
...
So how do you balance your remarkable content creation with your web design needs? It all starts with the "About Us" page.Download our collection of awesome 'About Us' page examples here, and get tips  for making yours great, too. 
